...
def get_plugin_info():
    plugin_info = {
        "name": "SMB远程溢出",
        "info": "MS17-010（NSA Eternalblue SMB），攻击者可通过此漏洞执行任意代码进而导致服务器",
        " "   : "被入侵控制。",
        "level": "紧急",
        "type": "远程溢出",
        "author": "wolf@YSRC",
...
def check(ip, port, timeout):
    ...
    try:
        ...
        tree_connect_andx_request = "000000%xff534d42750000000018012000000000000000000000000000002f4b%sc55e04ff000000000001001a00005c5c%s5c49504324003f3f3f3f3f00" % ((58 + len(ip)), user_id.hex(), ip_hex)
